        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {isLoading ? (
            ...
            <div className="flex items-center gap-6">
              <div className="h-20 w-20 rounded-lg overflow-hidden border-2 border-border flex-shrink-0">
                <img
                  src={category.image}
                  alt={category.name}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {posts.map((post) => (
                <Link
                  ...
                  className="group bg-card rounded-lg border border-border hover:border-primary overflow-hidden transition-all hover:shadow-lg"
                >
                  {post.image && (
